...
import { ChatSession, ChatMessage, Attachment, ChatMessageRole } from '../types';
...
export interface UseAutoSendReturn {
  ...
  isWaitingForErrorRetry: boolean; // New: For UI to show countdown
  errorRetryCountdown: number;    // New: For UI to show countdown
}
