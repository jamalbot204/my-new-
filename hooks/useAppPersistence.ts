...
import { ExportConfiguration, ChatSession } from '../types'; // Added ChatSession
import * as dbService from '../services/dbService';
import { METADATA_KEYS } from '../services/dbService';
import { DEFAULT_EXPORT_CONFIGURATION, INITIAL_MESSAGES_COUNT, DEFAULT_SETTINGS } from '../constants';
