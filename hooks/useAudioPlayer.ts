...
import { strictAbort } from '../services/cancellationService'; // Import strictAbort
...
export function useAudioPlayer(
  ...
  const startPlaybackInternal = useCallback(async (
    ...
    const { sourceNode, duration } = await playPcmAudio(audioContextRef.current, pcmBuffer, 24000, startTimeOffset);
