...
import { DEFAULT_SETTINGS, THINKING_BUDGET_MIN, THINKING_BUDGET_MAX, THINKING_BUDGET_STEP, THINKING_BUDGET_MARKS } from '../constants';
...
const ThinkingBudgetControl: React.FC<ThinkingBudgetControlProps> = ({
  value,
  onChange,
  ...
  const getBudgetValueDisplay = (val: number | undefined): string => {
